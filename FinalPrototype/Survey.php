	...
	<body oncontextmenu="return false" unselectable="on" onselectstart="return false;">		
		<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" name="formulaire">            
			<fieldset class="cadre">
			        <div style="z-index:10; position:relative;"><a href="Survey_finnish.php"><img draggable="false" id="flag" src="flags/fi.png"></a>
                    </div>
			    <div style="z-index:3;"><h1>Hello, please take some time to answer these questions :)</h1>
                </div>
				...
				<div align="center" id="gender">
                    <table>
                        ...
                        <tr>
                            <td align="center" valign="middle">Sound coming from the display was effective at catching my attention.</td>
                            <td width="20">&nbsp;</td>
                        ...
                        <tr><td colspan="13" height="20">&nbsp;</td></tr>
                        <tr>
                            <td align="center" valign="middle">Sound coming from the display was effective at letting me know the display interactive.</td>
                            <td width="20">&nbsp;</td>
